...
var BankServices_1 = require("./services/BankServices");
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var bank, Neel, Jay, Ram;
        return __generator(this, function (_a) {
            bank = new BankServices_1.BankService();
            Neel = bank.createAccount("Neel", 500);
            Jay = bank.createAccount("Jay", 300);
            Ram = bank.createAccount("Ram", 800);
            console.log("\nInitial Accounts:");
